...
class Helper:
    def __init__(self):
        ...
        ItemHandler.getProperty.__doc__ = "gets property of specified item (task/project)"
        ...
        ItemChanger.__doc__ = "utilities for changing tasks/projects"
        ItemChanger.changeTask.__doc__ = "gets task properties from input and applies them to the specified task"
        ItemChanger.changeProject.__doc__ = "gets project properties from input and applies them to the specified project"
